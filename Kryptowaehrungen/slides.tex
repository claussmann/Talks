...
\begin{frame}[fragile]{Die Blockchain}
    \begin{center}
        \boxwithtitle{3.5cm}{a}{Block \#1}{
            Transaktion 1\\
            Transaktion 2\\
            ...
        }
        \hspace{1cm}
        \boxwithtitle{3.5cm}{b}{Block \#2}{
            Transaktion 3\\
            Transaktion 4\\
            ...
        }
        \hspace{1cm}
        \boxwithtitle{3.5cm}{c}{Block \#3}{
            Transaktion 7\\
            Transaktion 8\\
            ...
        }
...
\begin{frame}{Hash-Pointer}
    \begin{center}
        \boxwithtitle{3.5cm}{a}{c6cc}{
            Vorgänger: null\\
            Transaktionen:\\
            ...
        }
        \hspace{1cm}
        \boxwithtitle{3.5cm}{b}{afaa}{
            Vorgänger: \textbf{c6cc}\\
            Transaktionen:\\
            ...
        }
        \hspace{1cm}
        \boxwithtitle{3.5cm}{c}{7ffa}{
